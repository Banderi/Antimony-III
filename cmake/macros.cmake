...
macro(PrintLibVars PackageName)
  PrintVar(USING_PREBUILT_${PackageName})
...
endmacro()
macro(PrintInterfaces Target)
  get_target_property(InterfacePaths ${Target} INTERFACE_INCLUDE_DIRECTORIES)
  PrintList(InterfacePaths "${Target} interface paths:")
endmacro()
macro(PrintDLLs)
...
macro(IncludePrebuilt PackageName)
  if (DEFINED ${PackageName}_PREBUILT)
    ...
    SetVar(USING_PREBUILT_${PackageName} ON)
    message("# ${PackageName} was found as pre-built files.")
  endif()
endmacro()
#macro(AddDependency TargetName PackageName CPMUri)
#  if (NOT DEFINED ${PackageName}_PREBUILT)
